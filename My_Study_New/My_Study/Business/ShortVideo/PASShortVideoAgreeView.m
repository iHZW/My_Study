...
#define gifSize 48.5f
#define ButtonSize 35.5f

@interface PASShortVideoAgreeView ()

@property (nonatomic, strong) UIButton *topImageButton;
@property (nonatomic, strong) UILabel *bottomLabel;
@property (nonatomic, strong) PASShortVideoAgreeAnimationView *animationView;

@end

@implementation PASShortVideoAgreeView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.topImageButton mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.top.equalTo(self).offset(gifSize-ButtonSize);
        }];
        ...
        self.animationView = [[PASShortVideoAgreeAnimationView alloc] init];
        [self addSubview:self.animationView];
        [self.animationView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.height.mas_equalTo(gifSize);
...
{
    _selected = selected;
    self.topImageButton.selected = selected;
}
