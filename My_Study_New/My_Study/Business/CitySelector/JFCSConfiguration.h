...
#define JFCSButtonItemH     36   //城市item 的高度 默认为  36
#define JFCSButtonItemV     10   //城市item 的纵向间距 10
...
/**
 *  设置浮窗类型 默认为 EHIndexViewStyleDefault  指向中心点
 */
@property (nonatomic, assign) EHIndexViewStyle indexViewType;
