...
- (UIButton *)cancelButton {
    if (!_cancelButton) {
        ...
        CGFloat x = CGRectGetWidth(self.searchBarBackgroundView.frame) - w;
...
- (UITextField *)searchTextField {
    if (!_searchTextField) {
        CGFloat w = CGRectGetWidth(self.searchBarBackgroundView.frame) - self.cancelButton.frame.size.width - _searchTextFieldR;
...
- (CGSize)sizeWithString:(NSString*)str {
    return [NSString getTextSize:str andFont:_config.searchControllerCancelButtonTitleFont];
}
