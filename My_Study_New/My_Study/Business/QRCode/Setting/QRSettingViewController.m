...
#import "Global.h"
#import "QRSettingViewController.h"
#import "UIAlertUtil.h"

@interface QRSettingViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation QRSettingViewController
        ...
        case 1: {
            if ([Global sharedManager].libraryType != SLT_ZXing) {
                if (indexPath.row == SCT_BarCodeITF) {
                    [UIAlertUtil showAlertTitle:@"提示" message:@"只有ZXing支持ITF码制识别" cancelButtonTitle:@"取消" otherButtonTitles:@[@"知道了"] actionBlock:^(NSInteger index) {
