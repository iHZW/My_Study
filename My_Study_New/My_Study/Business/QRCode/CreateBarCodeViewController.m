...
//    }];
    ...
    [UIAlertUtil showAlertTitle:@""
              ...
              otherButtonTitles:@[@"二维码+logo", @"二维码前景颜色+背景颜色", @"code13-商品条形码", @"支付宝付款条形码(code128)"]
...
- (void)createQR_logo {
    ...
    CGSize logoSize = CGSizeMake(kLogoWidth, kLogoWidth);
...
//    [LBXAlertAction showAlertWithTitle:@"提示" msg:str buttonsStatement:@[@"知道了"] chooseBlock:nil];
    ...
    [UIAlertUtil showAlertTitle:@"提示" message:str cancelButtonTitle:@"" otherButtonTitles:@[@"知道了"] actionBlock:^(NSInteger index) {
