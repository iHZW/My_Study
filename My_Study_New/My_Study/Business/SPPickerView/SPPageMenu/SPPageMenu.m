...
- (void)initialize {
    ...
    _selectedItemTitleColor = [UIColor colorFromHexString:@"#4F7AFDFF"];
...
- (void)setupSubViews {
    ...
    dividingLine.backgroundColor = [UIColor colorFromHexString:@"#E9E9EE"];
...
- (void)setTrackerStyle:(SPPageMenuTrackerStyle)trackerStyle {
    ...
    switch (trackerStyle) {
        ...
        case SPPageMenuTrackerStyleRect:
            self.tracker.backgroundColor = [UIColor colorFromHexString:@"#4F7AFDFF"];
