...
typedef NS_ENUM(NSInteger, GuideActionType) {
    /* 跳过 */
    GuideActionTypeJump = 0,
    /* 点击立即体验 */
    GuideActionTypeComplete
};

typedef void (^GuideCompleteBlock)(NSInteger index, GuideActionType type);
