...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HookLib/HookLib.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WKWebViewJavascriptBridge-ObjC/WKWebViewJavascriptBridge_ObjC.framework"
